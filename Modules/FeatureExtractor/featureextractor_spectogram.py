...
class FeatureExtractor:
    ...
    def clean_data(self, chunk):
        if 'frequency' in chunk.columns:
            spectrogram_chunk = chunk[['frequency', 'amplitude']]
        else:
            spectrogram_chunk = pd.DataFrame()
        
        spectrogram_chunk = spectrogram_chunk.fillna(spectrogram_chunk.mean())
        
        return spectrogram_chunk
    ...
    def create_output_file(self):
        ...
        self.output_file = os.path.join(csv_storage_path, 'extracted_features_spectrogram_frequency.csv')
    ...
    def process_chunks(self):
        ...
        for i, chunk in enumerate(chunk_iter):
            ...
            if not cleaned_chunk.empty:
                ...
                print(f"No 'frequency' column found in chunk {i}, skipping.")
